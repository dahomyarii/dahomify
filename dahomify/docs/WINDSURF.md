...
1. Preferred local path (Codex runner): `dahomify review --run-batches --runner codex --parallel --scan-after-import`.
2. Windsurf/cloud path: run `dahomify review --prepare` to generate `query.json`.
